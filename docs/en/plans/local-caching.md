...
> [data-continuity](../policies/data-continuity.md). Open work:
> [01-foundation-continuity](../features/01-foundation-continuity.md).
...
- [ ] Per-source TTL instead of one TTL passed ad hoc at call sites:
  - kino.pub item details — no cache headers on this endpoint (confirmed,
    [docs/archive/research-2026-07/09-metadata-integrations.md §1.8](../../archive/research-2026-07/09-metadata-integrations.md)) →
    our own TTL, hours.
...
- [ ] **Image pipeline** (own `NSCache` + disk + downsample layer). Parked — `AsyncImage` gets
      native HTTP caching in **27** (confirmed, [docs/archive/research-2026-07/07-ui-components-a11y.md](../../archive/research-2026-07/07-ui-components-a11y.md)),
