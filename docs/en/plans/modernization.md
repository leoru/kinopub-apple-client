...
> [AGENTS.md](../../../AGENTS.md), [policies](../policies/), [features](../features/),
> [apple-platform](../apple-platform/). Open work lives in feature docs (especially
> [01-foundation](../features/01-foundation-continuity.md)). English knowledge base:
> [docs/en/apple-platform/](../apple-platform/). Russian snapshot:
...
| --- | --- |
| Atoms, duplication, accessibility, type scale, focus / navigation / chrome cleanups | [01 — Foundation](../features/01-foundation-continuity.md) |
| Resume bugs, Skip Intro, subtitle rendering correctness, player perf and lifetime | [07 — Playback conveniences](../features/07-playback-conveniences.md) |
| Tap-a-word word-chip focus | [08 — Advanced subtitles](../features/08-advanced-subtitles.md) |
...
`swiftLanguageModes: [.v5]` (language mode 6 deferred per [04 §4.4](../../archive/research-2026-07/04-cross-platform.md);
...
- [x] `swift-tools-version: 6.2` in all five (`.v26` requires PackageDescription 6.2, not 6.0;
  ```
  see [04](../../archive/research-2026-07/04-cross-platform.md)). App `SWIFT_VERSION` stays `5.0` with
  `swiftLanguageModes: [.v5]` on packages — language mode 6 deferred until `@Observable`
  (see [04 §4.4](../../archive/research-2026-07/04-cross-platform.md)).
  ```
...
- [x] New `Packages/KinoPubUI/Sources/KinoPubUI/Layout/`: `CardAspect.swift` (2:3 / 16:9 / 1:1),
  ...
  [01 §4.2 MED-1](../../archive/research-2026-07/01-layout.md).
  ```
...
- Bring the poster overlays back on tvOS behind an explicit `.hoverEffect(.highlight)` on the
  ...
  ([06 §4.1-4.2](../../archive/research-2026-07/06-tvos-focus.md)). Verify on a real remote — if the group
...
— see [05 §1.4](../../archive/research-2026-07/05-player-media.md)) must still take its styling from the system
...
Full list in [05 §4](../../archive/research-2026-07/05-player-media.md). The correctness bugs here are not
